 ...
 * @copyright 	Copyright (c) 01/04/2015
 *
 */
...
var map;
var i, player, story, settings, Hammer, alert, game_data, google;

/**
 *	
 *	Geolocation Logic
 *
 *	1. On error if the location element cannot be found. Fall back shown.
 *
 *	2. OnSuccess - All things working nicly and the game cycles the markers and adds the icons.
 *
 */
...
/** 
 *	Grabs the enws from the array then dynamically populates the article element with the content.
 * 
 */				
...
/**
 *	Clears the flyout of content ready for next load and resets the var.
 * 
 */				
 ...
 * Called by the hammertime on the init.
 */				
...
function onDeviceReady() {
	...
	/**
	 *	
	 * The Core Setup Function
	 *
	 * Part 1 - Adds the PhoneGap DeviceReady Listener for device functionality.
	 * Part 2 - Adds the various click function logic to the app
	 * Part 3 - Adds Guesture Detection
	 * Part 4 - Device Ready Callback Functions - Mainly AJAX loading actions
	 * Part 5 - Custom Lore Animation Logic
	 * 
	 */			
	...
	$(document).ready(function(){
		...
		// Used for desktop debug as onDeviceReady never fires on desktop.
		...
		// Geolocation Game Click Actions
		
		$("#button_1").click(function(){
			
			// Google Maps API - Creates Marker at the devices location
			...
			// Pans the view to the markers location
		...
		/*
		 *
		 * Guestures with Hammer.js
		 * 
		 * Checks if news draw is open then acts accordingly. 
		 *
		 *
		 */
		...
		/* Get Clicked Items Top and height vars -> make position absolute -> Float out of the flow and make full height */
