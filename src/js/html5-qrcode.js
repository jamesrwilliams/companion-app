GridSampler = {checkAndNudgePoints: function(d, a) {
...
DataMask = {forReference: function(d) {
        if (0 > d || 7 < d)
...
qrcode = {imagedata: null,width: 0,height: 0,qrCodeSymbol: null,debug: !1,sizeOfDataLengthInfo: [[10, 9, 8, 8], [12, 11, 16, 10], [14, 13, 16, 12]],callback: null,decode: function(d) {
